 ...
 * @author ariel
 */
public class BibliotecaGrupo64 {
    ...
    public static void main(String[] args) {
        ...
        //Libro libro = libroData.buscarLibroPorId(7); 
        //PrestamoData pd = new PrestamoData(); 
        //pd.devolverLibro(lector, libro);     
        
        
        //----------------------------------PRUEBA LISTAR PRESTAMOS ----------------------------------
        
        //PrestamoData pd = new PrestamoData(); 
        //List<Prestamos> prestamos = pd.listarPrestamosActivos();
        //System.out.println(prestamos);
        
        //---------------------------------PRUEBA BUSCAR PRESTAMO POR ID--------------------------------
        PrestamoData pd = new PrestamoData(); 
        Prestamos prestamo = pd.buscarPrestamoPorId(2);
